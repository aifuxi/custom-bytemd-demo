    ...
    resources: {
      en: {
        translation: {
          ...
          [I18N_KEYS.COMMENT]: 'Have a problem? Comment below.',
          [I18N_KEYS.GO_TO_COMMENT]: 'Go to comment',
          [I18N_KEYS.TOC]: 'Table of Contents',
        },
      },
      zh: {
        translation: {
          ...
          [I18N_KEYS.SWITCH_TO_ENGLISH]: '切换为英文/Switch to English',
          [I18N_KEYS.COMMENT]: '遇到问题了？下方评论区交流',
          [I18N_KEYS.GO_TO_COMMENT]: '跳转到评论区',
          [I18N_KEYS.TOC]: '目录',
        },
      },
    },
